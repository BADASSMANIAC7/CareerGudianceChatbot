...
<body>
    <div class="container form-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            $career = escapeshellarg(strtolower(trim($_POST["career"])));
            $python = "C:\\Users\\r̥ṭñ\\AppData\\Local\\Programs\\Python\\Python310\\python.exe";
            ...
            if ($output) {
                ...
                echo "<h2>Roadmap for <span>" . htmlspecialchars(ucwords($_POST["career"])) . "</span></h2>";
            ...
            echo "<p class='error'>⚠️ Invalid request method.</p>";
        }
        ?>
    </div>
